...
o Download Nutanix Calm blueprint (.json) in order to run blueprint in Prism Cnetral hosted Calm service.
o On upload to Calm service all previous blueprint credentials are invalidated
o Create new private/public key pair
o Populate blueprint credentials (with private key) and application profile variables (with public key string)
o Sample key pair that can be used if needed, is below :
